...
while True:
    ...
    if choice == "1":
        ...
        print("What name would you like to see is on the list")
        name_choice = input("->")
        try:
            search_sense = searchList(name_choice)
            print("Searching for:", name_choice)
            ...
            print('Error finding name on list')
    elif choice == "3":
        try:
            print(getNumStudents())
            length_of_list = getNumStudents()
            print("There are", str(length_of_list), "students on the trip")
        except:
            print("Error calling student number list")
    elif choice == "4":
        try:
            print("The following students are signed up for the senior trip: ",students_signed_up_for_senior_trip)
        except:
            print("Error printing list of students")
    elif choice == "5":
        try:
            print("Exiting")
            break
